...
const menuItems: DashboardMenuItem[] = [
  ...
  { text: "الواردات", icon: <CurrencyExchange />, path: "/payments", permission: "payments:read" },
  { text: "وسائل الدفع", icon: <Payment />, path: "/payment-methods", permission: "payment-methods:read" },
